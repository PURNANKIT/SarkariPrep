...
const Header = () => {
  ...
  const calculateTimeLeft = () => {
    ...
    if (diff <= 0) {
      ...
      setCanStart(false); // Quiz is still locked
    }
  ...
  const handleJoinQuiz = () => {
    if (canStart) {
      ...
      alert(
        "⏳ Quiz abhi start nahi hua baby... countdown khatam hone ka wait karo ❤️"
      );
    }
  };
      ...
      <div className="header-overlay">
        <div className="header-content">
          ...
          <p className="header-subtitle">
            Stay updated with the latest happenings! Daily quiz starts every
            night at <span>8:00 PM</span>.
          </p>
