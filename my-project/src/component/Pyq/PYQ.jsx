...
//               {item.pdf && (
//                 <a
//                   href={`${API_BASE}${item.pdf}`} // ✔ Correct PDF link
//                   target="_blank"
//                   rel="noopener noreferrer"
//                   className="pyq-btn"
//                 >
...
const PYQ = () => {
  const { user, language } = useUser(); // <-- language added
  const { slug } = useParams(); // /pyq/:slug
  ...
  return (
    <div className="pyq-page">
      ...
      <div className="pyq-container">
        <h2 className="pyq-title">{title}</h2>
        <p className="pyq-sub">2022 - 2025 Previous Year Question Papers</p>
        ...
        <ul className="pyq-list">
          {pyqs.map((item, index) => (
            <li key={index} className="pyq-item">
              ...
              {/* ✔ Correct Hindi/English PDF switching */}
              <a
                href={
                  language === "hi"
                    ? `${API_BASE}${item.pdf_hi}`
                    : `${API_BASE}${item.pdf_en}`
                }
                target="_blank"
                rel="noopener noreferrer"
                className="pyq-btn"
